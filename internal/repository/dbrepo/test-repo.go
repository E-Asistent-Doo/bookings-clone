...
func (m *testDBRepo) SearchAvailabilityByDatesByRoomID(start, end string, roomID int) (bool, error) {
...
func (m *testDBRepo) Authenticate(email, testPassword string) (int, string, error) {
	...
	if email == "aleksa.dam997@gmail.com" {
		return 1, "", nil
	}
...
func (m *testDBRepo) DeleteteReservation(id int) error {
...
func (m *testDBRepo) InsertBlockForRomm(id int, startDate time.Time) error {
	return nil
}
